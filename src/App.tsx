...
>
  <div className="relative py-16">
    ...
    >
      ...
      {/* Контейнер с вариантами донатов */}
          ...
          <button
            onClick={() => {
              ...
              if (!Number.isFinite(n) || n <= 0) {
                alert("Enter a valid amount like 25");
                return;
              }
              const cents = Math.round(n * 100);
              openStripeInNewTab(() =>
                createCheckoutSession({ mode: "payment", amount: cents })
              );
            }}
        ...
        <div className="mt-3 flex gap-2 items-center justify-center">
          ...
          <button
            onClick={() => {
              ...
              openStripeInNewTab(() =>
                createCheckoutSession({ mode: "subscription", price_id: pid })
              );
            }}
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 grid md:grid-cols-3 gap-6 text-sm text-slate-600">
          <div>
            <div className="flex items-center gap-3">
              <img src="/logo.svg" alt="Exodus Recovery Logo" className="h-10 w-auto" />
